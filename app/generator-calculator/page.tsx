...
export default function GeneratorCalculatorPage() {
  ...
  const [litersPerHour, setLitersPerHour] = useState(() => suggestLitersPerHour(3.5, "petrol"));
  ...
  const result = useMemo(
    ...
    [litersPerHour, hoursPerDay, daysPerWeek, fuelPricePerLiter, annualMaintenanceCost]
  );
