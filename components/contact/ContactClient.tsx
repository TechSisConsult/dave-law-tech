  ...
  return (
    <main className="bg-dl-cream dark:bg-dl-darker min-h-screen transition-colors">
      <section className="bg-dl-gradient text-white">
        <div className="mx-auto max-w-6xl px-5 lg:px-8 py-28">
          ...
          <p className="text-white/60 mt-3 max-w-lg">
            ...
            <a
              href="/request-quote"
              className="underline text-dl-orange-light hover:text-dl-orange"
            >
              Request a Quote
            </a>{' '}
            instead.
      ...
      <section className="mx-auto max-w-6xl px-5 lg:px-8 py-14 grid lg:grid-cols-2 gap-10">
        ...
        >
          ...
          <a
            ...
            className="flex items-center justify-center gap-1 sm:gap-2 rounded-full bg-dl-green text-white px-4 sm:px-6 py-3.5 font-semibold hover:brightness-105 transition text-sm sm:text-lg"
          >
